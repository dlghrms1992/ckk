        ...
        <div class="flipping-section">
            ...
            <div class="fixed">
             ...
             <div class="cat-images">
                <div class="ci1">
                    <a href=""><img src="<c:url value="/images/index/idx1.png"></c:url>" alt="" class="cat-i" id="cat-img1"></a>
               <br></br>
                <p id="indp">MAIN DISH</p>
                </div>
                <div class="ci2">
                    <a href=""><img src="<c:url value="/images/index/idx4.jpg"></c:url>" alt="" class="cat-i" id="cat-img4"></a>
				<br></br>
                <p id="indp">DESSERT</p>
                </div>
                <div class="ci3">
                    <a href=""><img src="<c:url value="/images/index/idx3.jpg"></c:url>" alt="" class="cat-i" id="cat-img3"></a>
				<br></br>
                <p id="indp">DRINKS</p>
                </div>
                <div class="ci4">
                    <a href=""><img src="<c:url value="/images/index/idx2.jpg"></c:url>" alt="" class="cat-i" id="cat-img2"></a>
               <br></br>
                <p id="indp">LIQUORS</p>
                </div>
            </div> 
