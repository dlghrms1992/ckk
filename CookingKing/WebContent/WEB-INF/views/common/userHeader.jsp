...
<meta charset="UTF-8">
<title></title>
<link rel="stylesheet" href="<c:url value="/css/header.css"></c:url>" />
 <style>
...
<c:if test="${ memberLoggedIn == null }">
        <div class="user-header">
            <div class="user-navbar">
                ...
                <a href="<c:url value="${ pageContext.request.contextPath }"></c:url>"><button id="logo-btn" class="logo-btn">cooking-king</button></a>
