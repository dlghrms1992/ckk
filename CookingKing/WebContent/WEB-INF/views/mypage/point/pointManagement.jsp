...
<!-- 		<p class="push"></p> -->
	...
	<% } else { %>
	<div class="go-point">
		<input type="button" value="충전하기" onclick="location.href='<%=request.getContextPath()%>/point/pointDeposit'"/>
		<input type="button" value="환전하기" onclick="location.href='<%=request.getContextPath()%>/point/pointExchange'"/>
	</div>
	<% } %>
	</div>
</div>
